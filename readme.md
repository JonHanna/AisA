...
A is A is also available from [NuGet](https://www.nuget.org/packages/AisA). Run `Install-Package AisA` in the Package Management Console, or search for “A is A“ in the Package Manager of your IDE of choice.  
